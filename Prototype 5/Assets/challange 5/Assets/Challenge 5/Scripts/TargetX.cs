using System.Collections;                           // Gemaakt door mitchel wingelaar 
using System.Collections.Generic;                   // klas 1c1
using UnityEngine;

public class TargetX : MonoBehaviour
{
    private Rigidbody rb; // basic rigbody..
    ...
    // If target that is not the bad object trigger game over
    ...
    // Display explosion particle at object
    void Explode ()
    {
        Instantiate(explosionFx, transform.position, explosionFx.transform.rotation);
    }

    //  Moves the object behind background so it collides with the Sensor object
